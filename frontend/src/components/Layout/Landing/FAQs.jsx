  ...
  return (
    <section className="container py-20 pl-12 min-h-auto flex flex-row justify-between relative">
      ...
      <div className="w-[32rem]">
        <h2 className="text-[2.75rem] font-bold mb-5">Frequently Asked Questions</h2>
      ...
      <div className="w-[57rem]">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            >
              <span className="text-neutral-800 font-semibold text-xl text-left">{faq.question}</span>
            ...
            {openIndex === index && (
              <div className="py-4 pl-4 pr-12 bg-gray-50 text-neutral-500 font-medium text-base">{faq.answer}</div>
            )}
          </div>
        ))}
      </div>
